...
class TaskList extends React.Component {
    ...
    state={
        DATA: [
            ...
            { text: 'take medicine', completed: true, time: '5:00 am', id: '6' },
                ...
                <View style={{marginHorizontal:'10%'}}>
                    ...
                    <SafeAreaView style={styles.tasksContainer}>
                        <FlatList
                            ...
                            renderItem={({ item }) => <TaskRow completeTask={this.completeTask} text={item.text} completed={item.completed} time={item.time} />}
